...
export const CudyrView: React.FC<CudyrViewProps> = ({ readOnly = false }) => {
    ...
    return (
        <div className="space-y-6 animate-fade-in pb-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 print:max-w-none print:px-0 print:space-y-2 print:pb-0 print:break-inside-auto print:overflow-visible">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 overflow-visible print:shadow-none print:border-none print:p-0 print:break-inside-auto print:overflow-visible">
