    ...
    return (
        <>
            ...
            <tr className={clsx(
                ...
                {/* Action Menu */}
                <td className="py-1.5 px-2 text-center border-r border-slate-200 relative w-10 print:hidden">
                    <PatientActionMenu
                        isBlocked={!!isBlocked}
                ...
                {/* Bed Type */}
                <td className="py-1.5 px-2 border-r border-slate-200 text-center w-16">
                    <span className={clsx(
            ...
            {data.clinicalCrib && !isBlocked && (
                <tr className="hover:bg-slate-50 transition-colors border-b border-slate-200 text-[13px] leading-tight">
                    ...
                    <td className="py-1.5 px-2 text-right border-r border-slate-200 align-middle">
