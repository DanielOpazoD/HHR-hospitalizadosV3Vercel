...
const env = (typeof import.meta !== 'undefined' ? import.meta.env : process.env) as Record<string, string | undefined> & { DEV?: boolean };
const isDev = (typeof process !== 'undefined' && process.env?.NODE_ENV !== 'production') || Boolean(env?.DEV);
